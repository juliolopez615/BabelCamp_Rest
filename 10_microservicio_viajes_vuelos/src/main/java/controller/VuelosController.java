...
public class VuelosController {
	...
	@PutMapping(value="ActualizarVuelo/{idVuelo}/{plazas}")
	public void actualizar(@PathVariable("idVuelo") int idVuelo, @PathVariable("plazas") int plazas) {
		service.actuaizarVuelo(idVuelo, plazas);
	}
}
